                    ...
                    <div class="lg:flex lg:flex-wrap g-0">
                      <div class="w-full px-4 md:px-0">
                        <div class="md:p-12 md:mx-6">
                          ...
                          @if(session('status'))
                          <div class='bg-green-100 w-full text-center h-12 text-green-800'>
                              {{session('status')}}
                          </div>
                          @endif
                          <form method="POST" action="{{route('password.request')}}">
                            ...
                            <div class="relative">
                                <input name='email' type="email" id="floating_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-800 focus:outline-none focus:ring-0 focus:border-red-800 peer" placeholder=" " />
                            ...
                            <div class="flex items-center justify-between pb-6">
                              <p class="mb-0 mr-2">Already have an account?<a class='text-red-700 '> Login</a></p>
                            </div>
                            </div>
                          </form>
                        </div>

...
@section('content')
    ...
    <div class=''>
        ...
        <section class="h-full gradient-form bg-gray-200 md:h-screen">
            <div class="container py-12 mx-auto p-6 h-full">
                      ...
                      <div class="w-full px-4 md:px-0">
                        <div class="md:p-12 md:mx-6">
                          ...
                          <form method="POST" action="{{route('login')}}">
                            ...
                            <div class="relative">
                                <input name='index_number' type="text" id="floating_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-800 focus:outline-none focus:ring-0 focus:border-red-800 peer" placeholder=" " />
                                <label for="floating_filled" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-red-800 peer-focus:dark:text-red-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Index Number</label>
                                @error('index_number') <span class='text-red-500'>{{$message}}</span> @enderror
                            </div>
                            <div class="relative">
                                <input name='password' type="password" id="floating_filled3" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-800 focus:outline-none focus:ring-0 focus:border-red-800 peer" placeholder=" " />
                                <label for="floating_filled3" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-red-800 peer-focus:dark:text-red-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Password</label>
                            ...
                            <div class="flex items-center justify-between pb-6">
                              <p class="mb-0 mr-2">Don't have an account?<a class='text-red-700 ' href="{{route('register')}}"> register</a></p>
                            </div>
                            </div>
                          </form>
                        </div>
